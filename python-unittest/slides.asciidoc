...
=== Unit Tests Improved
  ...
  * Add tests to verify the other attributes.
+
[source,python]
------
...
=== Unit Tests Improved (Contd.)
  ...
  * Add tests to verify the behaviour using the level variant
+
[source,python]
------
...
------
  ...
  * link:{include:code/test_model_v5.py.datauri}["Version 5 of
    test_model.py",filename="test_model.py"] adds test cases to
