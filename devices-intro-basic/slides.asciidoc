...
image::figures/two-ram-nodecode.png[width="60%",align="center"]

=== Decoding Logic

  * Each RAM is assigned:
    - base
    - size

=== Assignment for RAM1 and RAM2
...
*p = 0x5;   /* write to the device register */
------
