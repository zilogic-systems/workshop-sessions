...
* The hello world program has to be compiled along with
  link:{include:code/csum/csum.full.datauri}["syscalls.c",filename="syscalls.c"].
  and new link:{include:code/csum/csum.full.datauri}["linker
  script",filename="csum.lds"].
