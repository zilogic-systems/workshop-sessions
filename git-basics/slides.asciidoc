...
image::figures/bug-fix.png[style="left",align="center"]
...
image::figures/git-repo.png[style="left",align="center"]
...
image::figures/branch-1.png[style="right",align="center"]
