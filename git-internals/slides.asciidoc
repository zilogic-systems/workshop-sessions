...
=== Tangled Working Copy Problem
  ...
  * You are working on Chapter 3, of the book
...
=== Tangled Working Copy Problem (Contd.)
  ...
  * You notice that there is a spelling mistake in every chapter of
    the book. 

  * The word "software" is spelled out as "softwere"
...
=== Tangled Working Copy Problem (Contd.)
  ...
  * You do not want to commit the paragraph that you added to Chapter
    3, but you want commit the spelling fixes
