...
----
PC$ convert logo: -fill none -stroke black -strokewidth 3 \
    	     -draw "rectangle 10,10 630,470" logo_rect.png

PC$ cp logo_rect.png ~/tftpboot
----

* Then the created image can be retrieved rendered on FB as

----
$ tftp -g -r logo_rect.png 10.0.2.2
$ cat rect.raw > /dev/fb0
----
